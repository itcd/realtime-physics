...
namespace nv
{
    struct Point
    {
        ...
        NVSDKENTRY const Point &operator= (const Point &p)
        {
            this->x = p.x;
            this->y = p.y;
            return *this;
    ...
    struct Rect
    {
        ...
        NVSDKENTRY const Rect &operator= (const Rect &r)
        {
            this->x = r.x;
            this->y = r.y;
            this->w = r.w;
    ...
    class UIContext
    {
        public:
            ...
            //////////////////////////////////////////////////////////////////
            NVSDKENTRY bool isOnFocus() const
            {
                return m_uiOnFocus;
            }
            ...
            NVSDKENTRY int getGroupWidth()
            {
                return m_groupStack[m_groupIndex].bounds.w;
            }
            NVSDKENTRY int getGroupHeight()
            {
                return m_groupStack[m_groupIndex].bounds.h;
            }

            NVSDKENTRY int getCursorX()
            {
                return m_currentCursor.x;
            }
            NVSDKENTRY int getCursorY()
            {
                return m_currentCursor.y;
            }

            NVSDKENTRY const ButtonState &getMouseState(int button)
            {
        ...
        protected:
            NVSDKENTRY UIPainter *getPainter()
            {
                return m_painter;
            }
